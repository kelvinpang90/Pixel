...
public class CompressPic {
    ...
    public static String compress(File srcFile, String type) {
        ...
        try {
            ...
            BigDecimal newWidth = new BigDecimal(map.get("width"));
            BigDecimal newHeight = new BigDecimal(map.get("height"));
            if (StringUtils.equals(type, "icon")) {
                newWidth = new BigDecimal("207");
                newHeight = new BigDecimal("294");
            } else if (StringUtils.equals(type, "microFilm")) {
                newWidth = new BigDecimal("985");
                newHeight = oldHeight.multiply(newWidth.divide(oldWidth,2,BigDecimal.ROUND_DOWN));
            } else if(StringUtils.equals(type,"weddingIcon")){
                newWidth = new BigDecimal("248");
                newHeight = new BigDecimal("248");
            }
